...
# 哎呀骇死我立，听说上一个员工因为莫名其妙搞了个SQL的备份被开除了。这次我可得小心点。
# c，难怪这人被开，测试代码都不带删的。我帮他删了。
# import random
...
def forgot_password():
    if request.method == 'POST':
        ...
        if user:
            # 听说UUID v8被嘿课橄榄了，那换个UUID v1吧
            token = str(uuid.uuid1(clock_seq=padding(email)))
